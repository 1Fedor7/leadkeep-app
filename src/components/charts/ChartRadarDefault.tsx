...
const chartConfig = {
  desktop: {
    label: "Klicks auf Facebook-Link",
    color: "var(--chart-1)",
  },
  ...
  return (
    <Card>
      <CardHeader className="items-center pb-4">
        <CardTitle>Link-Klicks</CardTitle>
        <CardDescription>
          So oft wurden Links, inklusive Werbeanzeigen, in deinen Inhalten angeklickt, angetippt oder gewischt.
        </CardDescription>
      </CardHeader>
